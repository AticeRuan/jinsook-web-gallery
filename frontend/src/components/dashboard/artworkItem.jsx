...
const ArtworkItem = ({ item, onUpdateClick, onDeleteClick }) => {
  ...
  return (
    <div className="w-[120px] md:w-[150px] group relative cursor-pointer items-center flex justify-center">
      <div className=" flex items-center border-2 rounded-lg overflow-clip border-jinsook-blue relative">
        <img
          src={item.imageUrl}
          alt={item.title}
          className="w-[100px] h-[100px] md:w-[140px] md:h-[140px] object-cover group-hover:grayscale group-hover:blur-[1px] transition-all duration-500 ease-in-out group-hover:opacity-60"
        />
